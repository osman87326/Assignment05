...
const is the third keyword to declare variables in JavaScript. It means that once the initial value of the variable has been set, it will not change again.
